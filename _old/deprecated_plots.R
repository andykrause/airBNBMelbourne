...
str_map <- ggplot() +
  geom_polygon(data=ssub_sf, 
               aes(x=long, y=lat, group=group), fill='white', color='grey70') 
...
<!-- ```{r plot_ratesrents, message=FALSE, warning=FALSE, comment=FALSE, echo=FALSE, fig.height=3, fig.width=5.75, fig.cap='\\label{rrdist}Distribution of Rates and Rents'} -->
  ...
  <!-- \autoref{locmap} shows the three large submarkets (Inner, Middle and Outer) and the individual suburbs boundaries. -->
  ...
  <!--    theme(axis.title.y=element_blank(), -->
                  ...
                  <!--          axis.text.x=element_blank(), -->
                  <!--          axis.ticks.x=element_blank()) -->
  <!--   ggsave(loc.map, filename=file.path(fig.path, 'loc_map.png'), -->
                  <!--           bg='transparent', -->
                  <!--          width=6, height=6) -->
  <!--  # loc.map -->
  ...
  <!-- ![Suburb Categories](c://dropbox/research/airBnb/figures/loc_map.png) -->
  
  
  ## OBSERVATION LOCATION MAPS
  ...
  <!--     ggsave(str.map, filename=file.path(fig.path, 'str_map.png'), -->
                    <!--          bg='transparent', -->
                    <!--          width=6, height=6) -->
  <!--     ggsave(ltr.map, filename=file.path(fig.path, 'ltr_map.png'), -->
                    <!--          bg='transparent', -->
                    <!--          width=6, height=6) -->
  ...
  <!-- ![Short Term Rental Locations](c://dropbox/research/airBnb/figures/str_map.png) -->
  
  <!-- ![Long Term Rental Locations](c://dropbox/research/airBnb/figures/ltr_map.png) -->
...
<!-- We will begin our analysis by making a comparison of the short and long-term markets at the metropolitan level.  Of our sample of 5,783 short-term rental units, 1,600 or 27.7\% of those units recorded a net revenue greater than what would likely have been garnered in the long-term market.   -->
  ...
  <!--   rate.hm <- abbHeatMap(str_df.ic, -->
                                 ...
                                 <!--                 alpha.count=T, -->
                                 <!--                 add.points=T, -->
                                 <!--                 fill.colors=c(strp.col, ltrp.col)) -->
...
<!--                     aes(x=x.var, y=Var, group=ID, color=ID)) +   -->
<!--     geom_point(alpha=.5, size=.4) + -->
<!--     stat_smooth(se=FALSE, size=1.5, span=.5) + -->
<!--     xlab('\nOccupancy Rate') + -->
<!--     scale_color_manual(values=sm.col, -->
<!--                        name='') + -->
<!--     scale_x_continuous(breaks=seq(0, 100, by=25), -->
...
<!--                    fill.colors=c(strp.col, ltrp.col)) + -->
<!--   theme(legend.position='none') + -->
<!--     ylab('Nightly Rate Percentile') + -->
<!--     xlab('Occupancy Rate Percentile') + -->
<!--   annotate("text", x = 50, y = 50, label = "City-Core", size=9) -->
...
<!-- ```{r plot_svm_geo, message=FALSE, warning=FALSE, fig.width=8, fig.height=8, echo=FALSE, fig.cap='\\label{smhmps}Geographic Submarket Heatmaps (SVM)'} -->
