...
```{r 22r.plot, message=FALSE, warning=FALSE, comment=FALSE, cache=FALSE, echo=FALSE, fig.width=4,fig.height=4}
...
```{r reason.plot, message=FALSE, warning=FALSE, comment=FALSE, cache=FALSE, echo=FALSE, fig.width=4,fig.height=4}
...
```{r}
  ...
  ggplot(abb.revs, aes(x=occ.rate)) +
