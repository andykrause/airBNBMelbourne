...
*Logistic regression to explain what is correlated with short-term preference
*3 Model approach, increasing complexity
*Need to explain log odds, interpretation, etc. 

```{r, results='asis', echo=FALSE, message=FALSE, comment=FALSE}
#full.table$Str.Model <- gsub(" ", "&nbsp;", full.table$Str.Model, fixed=TRUE)
