...
With the rise of Airbnb and other self-hosting accommodation platforms^[Flipkey.com, VRBO.com, Homeaway.com, Tripping.com as examples.], it is easier than ever for property owners and investors to consider short-term rental (STR) as a potential use for a revenue generating residential property. Should they though?  And which types of properties and in which locations would short-term leasing produce greater revenue than a traditional long-term rental (LTR), if any? 

To address these questions and provide some guidance to potential and current investors and owners, we use long-term rental data and nightly Airbnb listing information from the Melbourne (Australia) metropolitan area.  Melbourne has a thriving Airbnb market with over 20,000 total properties listed on the portal. We adopt a scenario-based approach in which we compare potential annual revenues for properties under both a short-term rental (STR) and a long-term rental (LTR) situation. Additionally, we break the results down by property types (apartment vs house), product type (ex. 1 bed, 1 bath) and by location (submarket).  Our results shows that the feasibility of a greater return through a short term rental is dependent on property type, product and location.  In answer to whether or not a owner or investor should opt for a short-term leasing strategy: it depends.  

## Literature Review

Existing research into short-term rental markets is sparse. However, with the arrival of Airbnb, and the controversies surrounding it, the topic is creating interest both in real estate and economics as well as in a wide variety of fields outside of real estate as evidenced by a growth in recent publications and on-going working papers. 

Much of the existing work focuses on price or rent formation in second home markets.  Specifically, the impacts of amenties such as water access [@nelson2010valuing], water quality [@gibbs2002hedonic; @clapper2014water] and proximity to ski facilities  [@soguel2008impact; @nelson2010valuing] and theme parks [@tsai2015impact] are shown to positively impact sales prices in tourism-dominated areas.  @benjamin2001value note that leasing policies, in this case smoking prohibitions, can also influence the weekly rental rates for vacation homes.  @nilsson2015influence makes a key distinction, finding that rural vacation home markets value amenties whereas urban holiday properties tend to derive large premiums from proximity to attractive residential areas.
...
* They are looking to maximize the revenue over the 12-month period from September 1, 2015 to August 31, 2016.
* The choices are 1) traditional year long rental (long term), or: 2) short-term, Airbnb type rental.
* Only direct monetary revenues and costs are considered, others such as liquidity and inconvience are not considered.  

We will not, a priori, specify a location or property type as we hypothesize that the preference of a short-term rental over a long-term one will vary by the location and property characteristics.  Additionally, Australia implements a particular tax policy, often termed `negative gearing', that does allow for favourable tax treatment to real estate investors who experience greater costs than revenues on investment properties^[See @fane2004negative for a complete explanation of negative gearing.  However, as the negative gearing policy requires knowledge of the investor's personal income situation, we will not be considering any effects of this policy in our analysis here.  

One benefit of a short-term rental may be the ability to adjust the nightly rate over the course of the year to reflect changing demand and market trends. As future market trends are unknown at the time of purchase and the decision of long- vs short-term leasing strategy is asymetrically irreversable (can go from short to long, but not long to short), we make our comparisons using a fixed nightly (short-term) rate to respresent the most likely state of knowledge for our hypothetical investor on September 1, 2015. Both long- term rents and short-term rates and occupancy structures will be baesd on the market conditions as of this date.  

We do not directly observe properties that are utilized in both a short and long term leasing strategy.  Therefore, comparisons are done based on estimated or imputed revenues.  Most specifically, we will estimate short-term revenue for observations of long-term rentals (LTRs) and long-term revenue for observations of short-term rentals (STRs). A preference for short or long term leasing strategy will be determined based on comparing the observed and estimated revenues.    
### Comparison

In this above scenario we compare the 12-month revenues from the a long-term rental with those of a short-term rental.  We define returns here as the gross revenue minus the direct costs associated with each of the two tenure possibilities.
...
Where $Rev_{LT}$ is the net revenue for a long-term rental, $RevG_{LT}$ is the gross revenue and $C_{LT}$ are the costs associated with long-term rental. The gross long-term revenue is expressed by: 
...
The short-term revenue is expresse by:

\begin{equation}
RevG_{ST} = Rate_{N} * O_{Total}
\end{equation}

where $Rate_{N}$ is the average nightly rate and $O_{Total}$ are the total number of occupancies (bookings) over the 12-month period.

We have limited our consideration of costs in this case to be those undergone during a single year of ownership.  Broadly speaking, these fall into three categories for long-term rental and four categories for short-term properties.  Long-term costs are summarized as:

\begin{equation}
C_{LT} = T + M + F
\end{equation}

where $T$ are tax related expenses, $M$ are general maintenance expenses and $F$ are finaning costs. Short-term properies experience the same three costs ($T$, $M$ and $F$) plus additional janitorial costs between each of the short-term occupants. 

\begin{equation}
C_{ST} = T + M + F + J
\end{equation}

As our scenario compares a hypothetical and particular owner over the course of a single  year the tax $T$ and $F$ costs are identical between the two leasing strategy and therefore cancel out. General maintenance $M$ expenses may differ between the two strategies, and an argument could be made for either to be higher. Long-term renters spend more time in the property over the course of the year and bring their own appliance and furniture which may damage the home. They are also more likely to affix items to the structure.  Conversely, short-term rentals are usually furnished and the occupants have less incentive not to be evicted as their damage is not often uncovered until after they have left^[Note that Airbnb's rating policy may help protect hosts as bad guests can be flagged on the platform.].  Both arguments are meritous and we were unable to find any evidence to support maintenance costs being higher in short or long term rentals. As a result we have made the assumption that the maintenance costs will be identical, and they too cancel out. 

Finally, we have janitorial costs $J$. These cover the costs to 'turn-over' the property between occupants.  For a short-term leasing strategy, these costs can be experiences every day or two, depending on the minimum length of stay and the total number of occupancies over the course of the year. Our data for short-term rentals comes from the Airbnb platform.  In addition to the nightly rate that an occupant pays to the owner there is also a separate 'cleaning fee' that is attached, as is a booking fee to Airbnb. Some hosts add additional 'linen' fees to cover costs of laundering.  While it may be advantageous for hosts in competitive markets to underquote their cleaning fees to keep occupancies up, we have no evidence to suggest that owners are exhibiting such behavior.  As a result of janitorial fees being a separate line item and directly paid by the occupants can also be ignored in the comparative analysis below as they are direct.      

Given that the costs cancel out between the two options, we will consider short-term rental (STR) strategy to be prefable to long-term rental (LTR) strategy if the following inequality holds:
...
```{r load_beforePT, message=FALSE, warning=FALSE, cache=FALSE, comment=FALSE, echo=FALSE, results='hide'}
  data.path <- 'c:/dropbox/research/airBNB/data/'
  load(paste0(data.path, '/analyzed/abb_beforePT.RData'))
  abb.data1 <- before.PT$abb.data
  ltr.data1 <- before.PT$ltr.data

```

```{r type_comp, message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=FALSE, fig.height=3, fig.cap='Tenure Type by Property Type', fig.lp='typecomp'}

  # Create Airbnb plot

  abb.types <- ggplot(abb.data1, aes(x=type)) +
  ...
  ltr.types <- ggplot(ltr.data1, aes(x=type)) +
...
```{r remove_others, message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=FALSE}
  ...
  abb.data1 <- subset(abb.data1, type != 'Other')
  ltr.data1 <- subset(ltr.data1, type != 'Other')
...
```{r ltype_comp, message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=FALSE, fig.height=2.5, fig.width=3.75, fig.cap='Listing Type of Short Term Rentals'}
  ...
  abb.data1$listing.type <- as.character(abb.data1$listing.type)
  abb.data1$listing.type[abb.data1$listing.type == 'Entire home/apt'] <- 'Entire home'

  # Make Plot

  ggplot(abb.data1, aes(x=listing.type)) +
...
```{r keep_entire_home, message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=FALSE}
  ...
  abb.data1 <- abb.data1[abb.data1$listing.type == 'Entire home', ]
...
We begin by removing all properties that are missing bedroom information or have a likely data error in this fields (more than 14 bedrooms). For both short and long term rentals we see that most apartments have less than 4 bedrooms and houses less than 5 (Figure 3).  We filter the data accordingly. Additionally, note that short term rentals consider studio apartments to be 0 bed units while the long term data considers these as 1 bedroom. We convert the 0 bed short term units to 1 bed units.
...
```{r bed_fltr, message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=FALSE}
 ...
 # Remove missing and data errors
  ...
  # Long term data
  ltr.data1 <- ltr.data1[!is.na(ltr.data1$bedrooms), ]
  ltr.data1 <- ltr.data1[ltr.data1$bedrooms <= 10, ]

  # Short term data
  abb.data1 <- abb.data1[!is.na(abb.data1$bedrooms), ]
  abb.data1 <- abb.data1[abb.data1$bedrooms <= 10, ]
...
```{r bed_fltr2, message=FALSE, warning=FALSE, comment=FALSE, cache=FALSE, echo=FALSE, fig.height=3.5, fig.cap='Bedrooms by Tenure & Property Type'}
 ...
 # Build long term bar plot
   ...
   ltrbed <- ggplot(ltr.data1, aes(x=bedrooms)) +
 ...
 # Build short term bar plot
  ...
  abbbed <- ggplot(abb.data1, aes(x=bedrooms)) +
...
```{r bed_fltr3, message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=FALSE}
 ...
 # Remove all with more than 4 beds
  ...
  abb.data1 <- abb.data1[abb.data1$bedrooms < 5, ]
  ltr.data1 <- ltr.data1[ltr.data1$bedrooms < 5, ]

 # Remove apartments with more than 3

  abba <- which(abb.data1$bedrooms > 3 & abb.data1$type =='Apartment')
  ltra <- which(ltr.data1$bedrooms > 3 & ltr.data1$type =='Apartment')

  if(length(abba) > 0) abb.data1 <- abb.data1[-abba, ]
  if(length(ltra) > 0) ltr.data1 <- ltr.data1[-ltra, ]

  # Convert 0 Bed to 1 Bed
  abb.data1$bedrooms[abb.data1$bedrooms == 0] <- 1

```

We then turn to bathrooms, starting by looking at the distribution of baths between short/long and apartment/house. Here we see that nearly all properties have 3 or fewer bathrooms and we filter the data accordingly (Figure 4). A few short term properties indicate no baths, which is likely an error so we remove these observations from the data. Also, here we notice that the short term data gives bathrooms in halves, while the long term data presents baths in whole numbers.  We round the baths in the short term data up to whole integers.

```{r bath_fltr, message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=FALSE}

 # Remove missing data

  ltr.data1 <- ltr.data1[!is.na(ltr.data1$baths), ]
  abb.data1 <- abb.data1[!is.na(abb.data1$baths), ]
...
```{r bath_fltr2, message=FALSE, warning=FALSE, comment=FALSE, cache=FALSE, echo=FALSE, fig.height=3.5, fig.cap='Bathrooms by Tenure & Property Type'}
 ...
 # Build long term plot
  ...
  ltbath <- ggplot(ltr.data1, aes(x=baths)) +
    geom_bar(fill=ltr.col, color=ltr.col) +
    facet_wrap(~type) +
 ...
 # Build short term plot
  ...
  stbath <- ggplot(abb.data1, aes(x=baths)) +
    geom_bar(fill=str.col, color=str.col) +
    facet_wrap(~type) +
...
```{r filtBB2, message=FALSE, warning=FALSE, comment=FALSE, cache=FALSE, echo=FALSE, fig.height=3.5, fig.cap='Bed/Bath Combo by Tenure & Property Type'}
 ...
 # Make long term plot
  ...
  ltb <- ggplot(ltr.data1, aes(x=bedbath)) +
    geom_bar(fill=ltr.col, color=ltr.col) +
    xlab('') +
    ylab('# of Props\n') +
 ...
 # Make short term plots
  ...
  stb <- ggplot(abb.data1, aes(x=bedbath)) +
    geom_bar(fill=str.col, color=str.col) +
    xlab('') +
    ylab('# of Props\n') +
...
```{r filtBB3, message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=FALSE}
 ...
 # Filter data
  ...
  ltr.data1 <- ltr.data1[ltr.data1$bedbath %in% acc.bb, ]
  abb.data1 <- abb.data1[abb.data1$bedbath %in% acc.bb, ]
...
```{r exch_rate_adj, message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=FALSE}
  ...
  abb.data1$average.daily.rate <- abb.data1$average.daily.rate * exch.rate
  abb.data1$nightly.rate <- abb.data1$nightly.rate * exch.rate
  abb.data1$weekly.rate <- abb.data1$weekly.rate * exch.rate
  abb.data1$monthly.rate <- abb.data1$monthly * exch.rate
...
```{r ltprice_fltr2, message=FALSE, warning=FALSE, comment=FALSE, cache=FALSE, echo=FALSE}
  ...
  ltr.plot <- ggplot(ltr.data1, aes(x=event.price)) +
  ...
  # Nightly Rate plot
  rate.plot <- ggplot(abb.data1, aes(x=nightly.rate)) +
...
```{r load_afterSP, message=FALSE, warning=FALSE, cache=TRUE, comment=FALSE, echo=FALSE, results='hide'}
  ...
  abb.data2 <- after.SP$abb.data
  ltr.data2 <- after.SP$ltr.data
...
We assign these designations by: 1) Adding suburb designations to the properties; 2) Assigning submarkets 1-4 based on suburb location; and 3) Indicating proximity to beach and labeling as 'Beach' submarket.  This process is repeated for both the short and long term data. Finally, we also remove any observations that fall outside of outer suburbs (the extent of the suburbs). The location of the short and long term rentals, colored by submarket, are shown in Figure 8.
...
```{r abb.plot, message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=FALSE}
  ...
  abb.map <- ggplot() +
    ...
    geom_point(data=abb.data2, aes(x=longitude, y=latitude, color=sub.mrkt), size=.2,
               alpha=.2) +
...
```{r ltr.plot, message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=FALSE}
  ...
  ltr.map <- ggplot() +
    geom_polygon(data=subs, aes(x=long, y=lat, group=group), color='gray80', fill='gray90') +
    geom_point(data=ltr.data2, aes(x=longitude, y=latitude, color=sub.mrkt), size=.1,
               alpha=.1) +
    scale_color_manual(values=sm.col) +
    scale_x_continuous(limits=c(min(subs$long), max(subs$long))) +
    scale_y_continuous(limits=c(min(subs$lat), max(subs$lat))) +
...
```{r loc.plot, message=FALSE, warning=FALSE, comment=FALSE, cache=FALSE, echo=FALSE, fig.width=5.5, fig.height=9, fig.cap='Location Maps'}

  ggMultiPlots(abb.map, ltr.map, cols=1)

```

To better visualize the relative frequency of the submarkets in the two tenure types we have broken down the data by submarket by property type by tenure type. A number of interesting observations are illustrated here (Figure 9). First, the vast majority of Airbnb units are apartments in city-core or city locations. As expected and as shown by the map, the long term properties are more evenly spread across the metro region than the short term properties.  Long term houses are more peripheral than apartments, a result of urban development patterns and land economics. Beach properties are, relatively speaking, over-represented in the short term market, especially in apartments, while suburban and rural apartments, somewhat common in long term markets, are nearly absent in the short-term market. Overall, the suburban and rural Airbnb markets are quite thin, later results focusing on these markets will need to be examined in light of this small sample size.
...
```{r smtype.plot, message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=FALSE, fig.width=9}
  ...
  abbtype.map <- ggplot() +
    geom_bar(data=abb.data2, aes(x=sub.mrkt, fill=sub.mrkt)) +
  ...
  ltrtype.map <- ggplot() +
    geom_bar(data=ltr.data2, aes(x=sub.mrkt, fill=sub.mrkt)) +
    scale_fill_manual(values=sm.col) +
    facet_wrap(~type) +
    ylab('# of Properties\n') + xlab('')+
    theme(legend.position = 'bottom',
...
```{r abbtype.plot, message=FALSE, warning=FALSE, comment=FALSE, cache=FALSE, echo=FALSE, fig.width=9,fig.height=7, fig.cap='Observations by Submarket'}

  ggMultiPlots(abbtype.map, ltrtype.map, cols=1)
...
```{r, results="asis", echo=FALSE, fig.cap='Imputation Model Diagnostics'}
...
```{r message=FALSE, warning=FALSE, comment=FALSE, cache=FALSE, echo=FALSE, fig.width=5, fig.height=3.5, fig.align='center', fig.cap='Probability of Short Term Pref. vs Occ. Rate Quantile'}

  qtlocc.pplot

```

Along with occupancy rates, the other important consideration is the nightly rate.  High occupancy rates with low nightly rates may not be any better than lower occupancy rate with a higher nightly rate.  In Figure 15 (left panel) we plot nightly rates versus occupancy rates.  We then divide the area of the scatter plot into 400 equal areas (20 x 20) and color each based on which is more common in the area, short term or long term revenue.  The transparency is related to the total count of actual market properties falling into that area.

The general trend is what is expected, i.e. that higher rates and occupancies, ceteris paribus, means more profitability for short term rentals.  This relationship is not a perfectly linear because the long-term rental revenue varies greatly based on the characteristics of the property.  While the left panel of Figure 15 helps show the general pattern is doe leave many indeterminate areas.  In order to better delimit the situations where short-term rentals are more profitable we turn to a support vector machine (SVM) algorithm.
...
Both the occupancy rates and the nightly rates are not uniformly distributed and therefore the plots in Figure 15 may be misleading.  We convert both axis to quantiles and replot both in Figure 16.  Here we see a more even distibution of points across the figures.  Additionally, a more reasonable SVM breakdown occurs as well.  The right panel shows that in order for the likelihood of a property to be more profitable in short-term rental to be above 50\% the lowest occupancy rate it can have is 40\%, if the nightly rate is in the top 95th percentile of the market.  For example, if we drop the nightly rate to the median, the occupancy rate need to be at the 60th percentile.
...
```{r, results="asis", comment=FALSE,  echo=FALSE, fig.cap='Preference Analysis: Metro Area'}
...
We break the data down further by geographic submarket and property type and compare the results (quantile) in Table 5.  In the Actual (observed) revenues, the probabilty of short-term preference is highest in the core area of the city and lowest in the city, beach and suburban areas.  Interestingly, the rural area has a higher probably than all other but the core.  This is likely explained by the fact that there are few rural properties and those that are show some clustering near rural tourists activities like the Yarra Valley wine region (Figure 7). 

In the core and the city, apartments offer a higher probability than homes, the reverse in true in the suburban and rural areas. In the lower density areas it appears that tourists may prefer larger and more spacious dwellings and are willing to pay a premium for them, compared to long-term renters who may experience long commutes from these fringe locations.

Looking at the 'fitted' and 'svm area' figures we see a trend that these svm figures are higher than the actual observed for the core apartment and lower for nearly all of the rest of the categories.  This findings shows that for all but the core apartments, those properties that are more profitable as short-term cluster tightly in the area (the combination of nightly rate and occupancy rate) that are preferable for a short-term strategy. In other words, there is well defined combination or situation in which these properties can be more profitable than in a long-term lease.  The reverse is true of the city core apartments. Here, the area of the plots occupied by short term preference is larger than the total proporation, suggesting that a wide variety of combinations of nightly rates and occupancy rates will result in a short term preference.
...
Finally, in Model three we add three variables describing policies set by the Airbnb hosts:
