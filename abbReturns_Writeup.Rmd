...
1. Need to explain this.

```{r, results="asis", echo=FALSE, fig.cap='Preference Analysis: By Submarket'}
...
1. Logistic regression to explain what is correlated with short-term preference
2. 3 Model approach, increasing complexity
3. Need to explain log odds, interpretation, etc. 
