...
As the distribution of occupancy rates is not uniform the initial plot may be misleading as to the frequency of short-term rentals being more profitable than long term. In the right hand panel of \autoref{occpref} (right panel) we transform the x-axis to represent the quantile of the full distribution of occupancy rates. By doing so, we see that, in general, properties need to be in the upper 25th percentile of occupancy rates across the entire market in order to have a equal likelihood of being more profitable as a short-term rental than as a more traditional long term one.  
...
```{r, fig.width=9, fig.height=4, message=FALSE, warning=FALSE, echo=FALSE, fig.cap='\\label{smocc}Analysis of Quantile Rates: Metro Level'} 
...
```{r, results='asis', echo=FALSE, message=FALSE, comment=FALSE, fig.cap='\\label{pothm}Heatmaps of Potential Short Term Preference'}
...
```{r plot_hostblock, message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=FALSE, fig.height=3.5, fig.caption='\\label{hostblock}Host Blocking Tendencies', fig.lp='hostblock'}
...
```{r plot_hosttypes, message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=FALSE, fig.height=3.5, fig.caption='\\label{hostcat}Host Categories', fig.lp='hosttypes'}

ggMultiPlots(ps.host, mu.host, os.host, un.host, cols=2)
  
```

```{r plot_hostbar, message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=FALSE, fig.height=3, fig.width=4, fig.caption='\\label{htc}Host Type Counts'}
