...
To address these questions and provide some guidance to potential and current investors and owners, we use long-term rental data and nightly Airbnb listing information from the Melbourne (Australia) metropolitan area.  Melbourne has a thriving Airbnb market with over 20,000 total properties listed on the portal. We adopt a scenario-based approach that compares potential annual revenues for properties under both a short-term rental (STR) and a long-term rental (LTR) situation. Additionally, we break the results down by property types (apartment vs house), product type (e.g. 1 bed, 1 bath) and by location (submarket).  Our results shows that the feasibility of a greater return through a short term rental is dependent on property type, product and location.  In short, the answer to whether or not a owner or investor should opt for a short-term leasing strategy: it depends.  
