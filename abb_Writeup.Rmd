...
```{r plot_bb, message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=FALSE, fig.height=4, fig.width=5.75, fig.cap='\\label{bbtype}Bed and Baths by Tenure'}
...
```{r plot_suburbmap, message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=FALSE, fig.height=4, fig.width=4, fig.cap='\\label{locmap}Melbourne Submarkets', fig.lp='submap'}
...
```{r table_corelist, results="asis", comment=FALSE, message=FALSE, echo=FALSE, fig.cap='\\label{coretable}List of Core Suburbs', fig.lp='coresuburbs'}
...
```{r plot_locations, message=FALSE, warning=FALSE, comment=FALSE, cache=FALSE, echo=FALSE, fig.width=5.5, fig.height=9, fig.cap='\\label{pointmaps}Location Maps', fig.lp='locmaps'}
...
```{r message=FALSE, warning=FALSE, comment=FALSE, cache=FALSE, echo=FALSE, fig.width=7, fig.height=3.5, fig.cap='\\label{occpref}Probability of Short Term Pref. vs Occ. Rate'}
...
```{r, fig.width=8, fig.height=4, echo=FALSE, fig.cap='\\label{smhm}Analysis of Percentile Rates: By Type'}
...
```{r, results='asis', echo=FALSE, message=FALSE, comment=FALSE}
  ...
  pqtl.hm.svm <- abbHeatMap(pot.data.ic,
                   ...
                   quantile=T,
                   fill.colors=c(abb.col[1], abb.col[5]))
  pqtl.hm.svm <- pqtl.hm.svm + ylab('Nightly Rate (Qtl)')+
...
```{r, results='asis', echo=FALSE, message=FALSE, comment=FALSE, fig.height=3.5, fig.cap='\\label{pothm}Heatmaps of Potential Short Term Preference'}
...
```{r results='asis', message=FALSE, warning=FALSE, comment=FALSE, echo=FALSE}
 ...
 # Limit to the extrapolated pref type
  ...
  hpref.table[,2] <- hpref.table[,2]*100
  hpref.table[,3] <- hpref.table[,3]*100
