...
```{r ratesrents, message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=FALSE, fig.height=3, fig.width=5.75, fig.cap='Distribution of Rates and Rents'}
...
```{r loc.bars, message=FALSE, warning=FALSE, comment=FALSE, cache=FALSE, echo=FALSE, fig.width=8.5, fig.height=4, fig.cap='Submarket Observation Counts'}
...
```{r message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=FALSE}
...
```{r message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=FALSE, fig.height=3.5}
...
```{r message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=FALSE, fig.height=4}
...
<!--   core.hm.svm <- abbHeatMap(str.data.ic[str.data.ic$sub.mrkt ==  -->
<!--                                           'city-core', ], -->
<!--                    x.field='occ.qtl', -->
<!--                    y.field='rate.qtl', -->
<!--                    pref.field='str.ext.pref', -->
...
<!--     city.hm.svm <- abbHeatMap(str.data.ic[str.data.ic$sub.mrkt ==  -->
<!--                                           'city', ], -->
<!--                    x.field='occ.qtl', -->
<!--                    y.field='rate.qtl', -->
<!--                    pref.field='str.ext.pref', -->
...
<!--       sub.hm.svm <- abbHeatMap(str.data.ic[str.data.ic$sub.mrkt ==  -->
<!--                                           'suburban', ], -->
<!--                    x.field='occ.qtl', -->
<!--                    y.field='rate.qtl', -->
<!--                    pref.field='str.ext.pref', -->
...
<!--       rural.hm.svm <- abbHeatMap(str.data.ic[str.data.ic$sub.mrkt ==  -->
<!--                                           'rural', ], -->
<!--                    x.field='occ.qtl', -->
<!--                    y.field='rate.qtl', -->
<!--                    pref.field='str.ext.pref', -->
...
<!--       beach.hm.svm <- abbHeatMap(str.data.ic[str.data.ic$sub.mrkt ==  -->
<!--                                           'beach', ], -->
<!--                    x.field='occ.qtl', -->
<!--                    y.field='rate.qtl', -->
<!--                    pref.field='str.ext.pref', -->
...
<!--    raw.data <- rawocc$data -->
<!--    qtl.data <- qtlocc$data -->

<!--    raw.data$type <- 'Raw Occ. Rate' -->
<!--    qtl.data$type <- 'Qtl. Occ. Rate' -->
<!--    raw.data$type <- factor(raw.data$type,  -->
<!--                            levels=c('Raw Occ. Rate', 'Qtl. Occ. Rate')) -->
<!--    rq.data <- rbind(raw.data, qtl.data)  -->

<!--   ## Make quartile location plot -->

<!--   rq.pplot <- ggplot(rq.data, -->
<!--                      aes(x=x.var, y=Var, group=ID, color=ID)) + -->
<!--                 stat_smooth(se=FALSE, size=2, span=.7) + -->
<!--                 xlab('\nOccupancy Rate') + -->
<!--                 scale_x_continuous(breaks=seq(0, 100, by=25), -->
<!--                                    labels=c('0%', '25%', '50%', '75%', -->
<!--                                             '100%')) + -->
...
<!--     scale_y_continuous(breaks=seq(0, 1, by=.25), -->
<!--                        labels=c('0%', '25%', '50%', '75%', '100%')) + -->
<!--     scale_colour_manual(values=sm.col, -->
<!--                         name='') + -->
<!--     theme(legend.position='bottom') + -->
<!--     facet_wrap(~type) -->
...
<!-- broken down by the five geographic submarkets -- City-Core, City, Suburban, Rural and beach. Looking at different market segments such as property type, host type and home characteristics will follow. -->

<!-- Within the City-Core, approximately one out of three short-term properties brought in more net revenue than they likely would have under a long-term leasing scenario.  That figure drops to one in four for beach and rural properties, one in six for other city location and about one in nine for suburban locations.   -->


<!-- ```{r, fig.width=8, fig.height=8, echo=FALSE, fig.cap='xxx'} -->
