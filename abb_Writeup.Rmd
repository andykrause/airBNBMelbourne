...
We will begin our analysis by making a comparison of the short and long-term markets at the metropolitan level.  Of our sample of 5,783 short-term rental units, 1,600 or 31.6\% of those units recorded a net revenue greater than what would likely have been garnered in the long-term market.  
...
<!-- ```{r build_occ_type, message=FALSE, warning=FALSE, comment=FALSE, echo=FALSE} -->
...
Next, we divide the data into the five geographic sub-market shown in \autoref{pointmaps}. Within the City-Core, greater than one out of three short-term properties brought in more net revenue than they likely would have under a long-term leasing scenario.  That figure drops to three in ten for rural, one in four for beach , one in fix for other city location and about one in six for suburban locations. 
...
In short, about 30\% of current Airbnb properties are outperforming their potential in the long-term market.  If owners all operated as profit maximizers this figure could be 50\% or higher given that the overall demand for short-term rental could match the assumed supply increase in such a case.  
