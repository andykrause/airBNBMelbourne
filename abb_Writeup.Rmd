...
```{r plot_ltype, message=FALSE, warning=FALSE, comment=FALSE, cache=FALSE, echo=FALSE, fig.height=2.5, fig.width=3.75, fig.cap='\\label{ltypecomp}Listing Type of Short-Term Rentals'}
...
```{r plot_ratesrents, message=FALSE, warning=FALSE, comment=FALSE, cache=FALSE, echo=FALSE, fig.height=3, fig.width=5.75, fig.cap='Distribution of Rates and Rents'}
...
```{r plot_locations, message=FALSE, warning=FALSE, comment=FALSE, cache=FALSE, echo=FALSE, fig.width=5, fig.height=10, fig.cap='\\label{pointmaps}Location Maps', fig.ext='png'}
...
```{r plot_locbars, message=FALSE, warning=FALSE, comment=FALSE, cache=FALSE, echo=FALSE, fig.width=8.5, fig.height=4, fig.cap='\\label{smcounts}Submarket Observation Counts'}
...
```{r plot_occ_metro, message=FALSE, warning=FALSE, comment=FALSE, cache=FALSE, echo=FALSE, fig.width=7, fig.height=3.5, fig.cap='\\label{occpref}Probability of Short-Term Preference vs Occupancy Rate'}
...
```{r plot_svmr_metro, fig.width=8, fig.height=4, echo=FALSE, warning=FALSE, fig.align='center', fig.cap='\\label{metrohm}Analysis of Raw Rates: Metro Level'}
...
```{r log_model, results='asis', echo=FALSE, message=FALSE, comment=FALSE, fig.cap='Logistic Model Results of Short-Term Preference'}
...
```{r pot_logmodel, results='asis', echo=FALSE, message=FALSE, comment=FALSE, fig.cap='Logistic Model Results of Potential Short-Term Preference'}
...
```{r host_logmodel, results='asis', echo=FALSE, message=FALSE, comment=FALSE, fig.cap='\\label{logpot}Logistic Model Results of Potential Short-Term Preference'}
