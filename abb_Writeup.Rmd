...
<!-- Our final data filtering considers the observed gross revenue of the properties. For the long-term rentals the observed gross revenue is the weekly rate multiplied by 52 minus the number of weeks the property was on the market. In a number of extreme cases, time on market was extremely long and the total observed revenues very low. To remove these outlying observations, we filter out any properties with less than $10,000 in revenue. -->
...
<!--   strr <- str.data[,c('bedrooms', 'gross.revenue')] -->
<!--   strr$tenure <- 'short-term' -->
<!--   ltrr <- ltr.data[,c('bedrooms', 'gross.revenue')] -->
<!--   ltrr$tenure <- 'long-term' -->
<!--   allr <- rbind(strr, ltrr) -->

<!--   ggplot(allr, aes(x=gross.revenue, fill=tenure, color=tenure)) + -->
