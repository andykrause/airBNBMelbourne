...
```{r plot_revdens, message=FALSE, warning=FALSE, comment=FALSE, cache=FALSE, echo=FALSE, fig.width=6,fig.height=3.5}
  ...
  buildRevDensPlot(str.data.ic,
                   rev.cols=c(ltr.col, abb.col[2], str.col))
...
```{r message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=TRUE}
  ...
  pref.models <- list(mod.ext.str, mod.ext.loc, mod.ext.host, 
                      mod.pot.str, mod.pot.loc, mod.pot.host)
  names(pref.models) <- c('ext.str', 'ext.loc', 'ext.host',
...
```{r message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=TRUE}
  ...
  mod.ext.str.prem <- lm(str.ext.prem~type+as.factor(bedbath),
                    data=str.data.ic)
  mod.pot.str.prem <- lm(str.pot.prem~type+as.factor(bedbath),
                    data=str.data.ic)
  
  mod.ext.loc.prem <- glm(str.ext.pref~type+as.factor(bedbath)+
                                  sub.mrkt,
                     family=binomial(link='logit'),
                     data=str.data.ic)
...
```{r message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=TRUE}
  ...
  mod.pot.host.prem <- lm(str.pot.prem~type+as.factor(bedbath)+
    ...
    prem.models <- list(mod.ext.str.prem, mod.ext.loc.prem, mod.ext.host.prem, 
                      mod.pot.str.prem, mod.pot.loc.prem, mod.pot.host.prem)
    names(prem.models) <- c('ext.str', 'ext.loc', 'ext.host',
                          'pot.str', 'pot.loc', 'pot.host')
...
```{r message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=TRUE}
  ...
  mod.ext.ps <- glm(str.ext.pref~type+as.factor(bedbath)+
                    sub.mrkt+
                    I(max.guests/bedrooms)+min.stay+
                    I(cancel.policy=='Flexible') + I(cancel.policy=='Strict'),
                 family=binomial(link='logit'),
  ...
  mod.ext.os <- glm(str.ext.pref~type+as.factor(bedbath)+
                    sub.mrkt+
                    I(max.guests/bedrooms)+min.stay+
                    I(cancel.policy=='Flexible') + I(cancel.policy=='Strict'),
                 family=binomial(link='logit'),
  ...
  mod.ext.mu <- glm(str.ext.pref~type+as.factor(bedbath)+
                    sub.mrkt+
                    I(max.guests/bedrooms)+min.stay+
                    I(cancel.policy=='Flexible') + I(cancel.policy=='Strict'),
                 family=binomial(link='logit'),
  ...
  mod.ext.un <- glm(str.ext.pref~type+as.factor(bedbath)+
                    sub.mrkt+
                    I(max.guests/bedrooms)+min.stay+
                    I(cancel.policy=='Flexible') + I(cancel.policy=='Strict'),
                 family=binomial(link='logit'),
...
host.models <- list(mod.ext.ps, mod.ext.os, mod.ext.mu, mod.ext.un,
                    mod.pot.ps, mod.pot.os, mod.pot.mu, mod.pot.un)
names(host.models) <- c('ext.ps', 'ext.os', 'ext.mu', 'ext.un',
...
save(clean.count, daily.data, listing.data, ltr.data, pref.table,
     pref.table.wide, revdens.data, rawocc.metro, qtlocc.metro,
