...
```{r message=FALSE, warning=FALSE, comment=FALSE, cache=TRUE, echo=TRUE}
  ...
  mod.ext.host <- lm(str.ext.prem~type+as.factor(bedbath)+
                        sub.mrkt+
                        I(max.guests/bedrooms)+min.stay+
                        I(cancel.policy=='Flexible') + I(cancel.policy=='Strict') + suburb,
                      data=str.data.ic)
  mod.pot.host <- lm(str.pot.prem~type+as.factor(bedbath)+
                        sub.mrkt+
                        I(max.guests/bedrooms)+min.stay+
                        I(cancel.policy=='Flexible') + I(cancel.policy=='Strict'),
                      data=str.data.ic)
